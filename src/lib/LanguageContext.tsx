...
export const translations: Record<string, Record<Language, string>> = {
    ...
    hero_sample_onetime: {
        ...
        te: "శాంపిల్ బాక్స్ ఒక్కసారి ఆర్డర్ • సభ్యత్వం లేదు",
        kn: "ಸ್ಯಾಂಪಲ್ ಬಾಕ್ಸ್ ಒಂದು ಬಾರಿಯ ಆರ್ಡರ್ • ಚಂದಾದಾರಿಕೆ ಇಲ್ಲ",
        mt: "Kaxxa Kampjun hija Ordni ta' Darba Waħda • L-ebda Abbonament",
    },
    ...
    faq_a4: {
        ...
        ml: "അതെ, ഞങ്ങൾ ഒറ്റത്തവണ ഓർഡറുകൾ നൽകുന്നു. നിങ്ങൾക്ക് ഞങ്ങളുടെ സാമ്പിൾ ബോക്സ് പരീക്ഷിക്കാം, അവിടെ നിങ്ങൾക്ക് സ്വന്തം കസ്റ്റമൈസ്ഡ് സ്നാക്കുകൾ തിരഞ്ഞെടുക്കാം. ഞങ്ങളുടെ പ്രധാന ശ്രദ്ധ ആഴ്ചതോറും, രണ്ടാഴ്ചതോറും ഉള്ള സബ്സ്ക്രിപ്ഷനുകളിലാണ്, എന്നാൽ ഇവന്റുകൾക്കോ പ്രത്യേക അവസരങ്ങൾക്കോ വലിയ അളവിൽ ആവശ്യമുണ്ടെങ്കിൽ, ഞങ്ങളെ ബന്ധപ്പെടാൻ മടിക്കേണ്ട — സഹായിക്കാൻ ഞങ്ങൾ തയ്യാറാണ്.",
