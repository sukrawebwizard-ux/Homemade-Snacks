    ...
    <section className="mb-12">
      ...
      <section className="grid md:grid-cols-2 gap-6">
        {plans.map((plan) => (
          <article
            key={plan.id}
            className="relative rounded-2xl border bg-white p-5 shadow-sm flex flex-col"
          >
            ...
            <div className="mb-3">
              ...
              <ul className="text-[11px] text-slate-600 list-disc pl-4 space-y-0.5">
                ...
                <li>Freshly prepared in small batches for your delivery day</li>
                <li>
                  Room to customise what you like more (sweets, spicy, salt)
                </li>
              </ul>
            </div>
