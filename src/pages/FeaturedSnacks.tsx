...
const getSnackEmoji = (category: string) => {
  switch (category) {
    case "sweets":
      return "🍩";
    case "spicy":
        ...
        {SNACKS.map((snack) => (
          ...
          >
            ...
            <div className="flex flex-col gap-1 min-w-0">
              ...
              <p className="text-[11px] text-slate-500 flex items-center gap-1">
                ...
                <span className="truncate">
                  {snack.unit} • {snack.category === "sweets"
                    ? "Sweet"
            ...
            <div className="flex-shrink-0">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100 shadow-inner flex items-center justify-center text-3xl">
                {getSnackEmoji(snack.category)}
              </div>
            </div>
          </div>
        ))}
